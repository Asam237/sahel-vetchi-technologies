...
export const Header = () => {
    ...
    return (
        <header className={`py-6 shadow-md border-b z-50 sticky top-0 left-0 bg-white`}>
            <div className="container mx-auto">
                <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center">
                    <div className="flex lg:flex-row items-center">
                        <Link href={"/"}>
                            <AiOutlineStock className="text-gray-600" size={40} />
                        </Link>
                        {token ?
                            (
                                <ul className={`ml-4`}>
                    ...
                    {token ?
                            ...
                            < div className="flex justify-center items-center underline underline-offset-4">
                                <DropdownMenu>
                                    <DropdownMenuTrigger className="outline-none">
                                        <div className="flex flex-row text-primary font-bold items-center text-base">
                                            <AiOutlineUser size={24} className="mr-2" /> {name}
                                        </div>
                                    </DropdownMenuTrigger>
                                    <DropdownMenuContent
                                        sideOffset={5}
                                        className="bg-white shadow-sm border min-w-[150px] rounded text-base"
                                    >
                        ...
                        <div className="flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-4 mt-4 lg:mt-0">
                            <div className="flex justify-center items-center">
                                <Link href={'/login'} className="font-semibold text-base hover:underline hover:underline-offset-4 text-gray-600">
                                    Sign in
                                </Link>
                            </div>
                            <div className="flex bg-blue-700 text-white justify-center items-center px-6 py-3 rounded-md">
